...
export const DETAIL_COPY: Record<Locale, {
  ...
  en: {
    ...
    industry: ["All industries", "Industry", "Capabilities for this sector", "Delivery capabilities aligned to sector requirements.", "Have a requirement in this sector?", "Discuss the project with KAZENCO.", "Contact our team", "Related products", "Products supplied for this sector."],
  },
  ru: {
    ...
    industry: ["Все отрасли", "Отрасль", "Возможности для отрасли", "Возможности реализации, согласованные с требованиями отрасли.", "Есть потребность в этой отрасли?", "Обсудите проект с KAZENCO.", "Связаться с командой", "Соответствующая продукция", "Продукция, поставляемая для этой отрасли."],
  },
  tr: {
    ...
    industry: ["Tüm sektörler", "Sektör", "Bu sektöre yönelik yetkinlikler", "Sektör gereksinimlerine uygun uygulama yetkinlikleri.", "Bu sektörde bir ihtiyacınız mı var?", "Projeyi KAZENCO ile görüşün.", "Ekibimizle iletişime geçin", "İlgili ürünler", "Bu sektöre yönelik tedarik edilen ürünler."],
  },
  kz: {
    ...
    industry: ["Барлық салалар", "Сала", "Осы салаға арналған мүмкіндіктер", "Сала талаптарына сай орындау мүмкіндіктері.", "Осы салада қажеттілігіңіз бар ма?", "Жобаны KAZENCO-мен талқылаңыз.", "Командаға хабарласу", "Тиісті өнімдер", "Осы саламен жеткізілетін өнімдер."],
  },
};
