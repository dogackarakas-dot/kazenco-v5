...
export const PIPES_TUBES_DETAIL: Record<Locale, ProductDetailCopy> = {
  en: {
    ...
    technical: [
      { label: "Material families", value: "Carbon steel, stainless steel, alloy steel and duplex" },
      { label: "Manufacturing types", value: "Seamless and welded" },
      { label: "Applicable standards", value: "ASTM, ASME and API as required by the approved project specification" },
  ...
  tr: {
    ...
    technical: [
      { label: "Malzeme grupları", value: "Karbon çelik, paslanmaz çelik, alaşımlı çelik ve dubleks" },
      { label: "Üretim tipleri", value: "Dikişsiz ve kaynaklı" },
      { label: "İlgili standartlar", value: "Onaylı proje şartnamesine göre ASTM, ASME ve API" },
  ...
  ru: {
    ...
    technicalKicker: "Техническое соответствие", technicalTitle: "Основа поставки и документация", technical: [{ label: "Группы материалов", value: "Углеродистая, нержавеющая, легированная и дуплексная сталь" }, { label: "Типы производства", value: "Бесшовные и сварные" }, { label: "Применимые стандарты", value: "ASTM, ASME и API согласно утверждённой спецификации проекта" }, { label: "Документация", value: "MTC, CoC и согласованные записи качества согласно утверждённому RFQ" }, { label: "Основа поставки", value: "Спецификация, количество, требуемая дата и место доставки" }, { label: "Координация доставки", value: "Координация производителя, упаковка и планирование отгрузки" }],
  ...
  kz: {
    ...
    technicalKicker: "Техникалық сәйкестік", technicalTitle: "Жеткізу негізі және құжаттама", technical: [{ label: "Материал топтары", value: "Көміртекті, тот баспайтын, легірленген және дуплексті болат" }, { label: "Өндіріс түрлері", value: "Жіксіз және дәнекерленген" }, { label: "Қолданылатын стандарттар", value: "Бекітілген жоба сипаттамасына сәйкес ASTM, ASME және API" }, { label: "Құжаттама", value: "Бекітілген RFQ бойынша MTC, CoC және келісілген сапа жазбалары" }, { label: "Жеткізу негізі", value: "Сипаттама, мөлшер, қажетті күн және жеткізу орны" }, { label: "Жеткізуді үйлестіру", value: "Өндірушіні үйлестіру, орау және жөнелтуді жоспарлау" }],
...
const ADDITIONAL_PRODUCT_DETAILS: Record<Exclude<ProductDetailSlug, "pipes-tubes">, Record<Locale, CategorySpecificCopy>> = {
  "fittings-flanges": {
    en: {
      ...
      technical: [{ label: "Product families", value: "Buttweld fittings, forged fittings, flanges and special piping components" }, { label: "Material families", value: "Carbon steel, stainless steel and alloy steel" }, { label: "Applicable standards", value: "ASME B16.5, B16.9 and B16.11 as required by the approved specification" }, { label: "Pressure and dimensions", value: "Nominal size, schedule, pressure class, facing and end connection" }, { label: "Documentation", value: "MTC, CoC and agreed inspection or quality records" }, { label: "Delivery coordination", value: "Manufacturer coordination, packing and shipment planning" }],
    ...
    tr: {
      ...
      technical: [{ label: "Ürün grupları", value: "Alın kaynaklı bağlantı parçaları, dövme bağlantı parçaları, flanşlar ve özel borulama bileşenleri" }, { label: "Malzeme grupları", value: "Karbon çelik, paslanmaz çelik ve alaşımlı çelik" }, { label: "İlgili standartlar", value: "Onaylı şartnameye göre ASME B16.5, B16.9 ve B16.11" }, { label: "Basınç ve ölçüler", value: "Nominal çap, schedule, basınç sınıfı, yüzey ve uç bağlantısı" }, { label: "Dokümantasyon", value: "MTC, CoC ve mutabık kalınan muayene veya kalite kayıtları" }, { label: "Teslimat koordinasyonu", value: "Üretici koordinasyonu, paketleme ve sevkiyat planlaması" }],
